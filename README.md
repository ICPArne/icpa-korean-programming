...
- 이를 해결하기 위해 PyPI에 패키지를 배포하였습니다. "pip install whale"을 이용해 설치하신 후, "from whale import whale"을 이용해 실행하시면 됩니다. (2018년 12월 24일 기준, 최신 버전은 1.1.4입니다. 이하의 버전에서는 작동이 되지 않으므로 반드시 1.1.4 버전을 설치하시길 바랍니다.)
